...
// EAP SIM
#define RIL_REQUEST_SIM_TRANSMIT_BASIC 124
#define RIL_REQUEST_SIM_OPEN_CHANNEL 125
#define RIL_REQUEST_SIM_CLOSE_CHANNEL 126
#define RIL_REQUEST_SIM_TRANSMIT_CHANNEL 127
